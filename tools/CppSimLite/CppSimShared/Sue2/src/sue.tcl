...
#
# 08/06/2020: CHANGE to CppSimLite: Added evironment variable SPICE_BIN_PATH
#
set auto_noexec 1

# directory where sue is (this file is assumed to be down src)
global CPPSIM_HOME CPPSIMSHARED_HOME EDITOR tcl_platform SPICE_BIN_PATH

set SPICE_BIN_PATH $::env(SPICE_EXEC_DIR)
