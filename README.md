...
- [June 7] *Session-1*: Standard Cell Design. *Session-2*: Lab-7 -- Standard Cell Layout [Videos: [Session-1]() | [Session-1]()]
- [June 8] *Session-1*: MOS Device Equations: Refinement and additional effects. *Session-2*: Lab-8 -- Temperature effect on Vt and mobility. Python API for ngspice. [Videos: [Session-1]() | [Session-1]()]
